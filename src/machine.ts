...
import { ICard, isSet, createDeck, drawCards } from './model';
...
type AddCardEvent = EventType<'ADD_CARD', { card: ICard }>;
type RemoveCardEvent = EventType<'REMOVE_CARD', { card: ICard }>;
...
export const setMachine = createMachine<Context, Event>(
  {
    id: 'set',
